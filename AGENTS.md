Instrucciones compactas para agentes OpenCode. Léase antes de cualquier modificación.

## Lectura obligatoria antes de actuar

- `config_session/rules.md` — reglas de trabajo, commits checkpoint, autorización para cambios
- `config_session/memory.md` — contexto de sesión actual y último commit

Ambos son referenciados por `opencode.json` como `instructions`.
